export default function BookingEmbed() {
  return (
    <div className="glass mx-auto max-w-5xl rounded-[2rem] p-4 md:p-8">
      <div className="mb-6">
        <h2 className="text-3xl font-black text-[#171313]">Prendre rendez-vous</h2>
        <p className="mt-3 text-[#645c58]">
          Sélectionne un créneau disponible pour ton cours en ligne.
        </p>
      </div>

      <div className="overflow-hidden rounded-3xl border border-[#b88a3b]/25 bg-[#fffaf3]">
        <iframe
      ...
      <p className="mt-4 text-sm text-[#645c58]">
